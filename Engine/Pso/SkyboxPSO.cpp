...
void SkyboxPSO::Init(IDxcUtils* dxcUtils, IDxcCompiler3* dxcCompiler, IDxcIncludeHandler* includeHandler, const std::string& VS_fileName, const std::string& PS_fileName) {
	// 基底クラスの初期化
...
#pragma region inputElement
	...
	psoData_.inputElementDescs_[1].Format = DXGI_FORMAT_R32G32B32_FLOAT;
...
#pragma endregion
	...
	depthStencilDesc.StencilEnable = FALSE;  // ステンシルバッファを使用しない場合は無効にする
	...
	psoData_.graphicsPipelineStateDescs_.DepthStencilState = depthStencilDesc;
