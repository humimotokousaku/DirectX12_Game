...
class VignetingPSO : public IPSO
{
public:
	///
	/// Default Method
	...
	VignetingPSO(IDxcUtils* dxcUtils, IDxcCompiler3* dxcCompiler, IDxcIncludeHandler* includeHandler, const std::string& VS_fileName, const std::string& PS_fileName);
	~VignetingPSO() = default;
