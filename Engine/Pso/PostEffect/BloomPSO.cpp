...
#pragma region rootParameter
	...
	psoData_.rootParameters_[5].DescriptorTable.pDescriptorRanges = descriptorRange;
	psoData_.rootParameters_[5].DescriptorTable.NumDescriptorRanges = _countof(descriptorRange);
#pragma endregion
